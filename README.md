...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/zjukg/KG-LLM-Papers) ⭐ 2,232 | 🐛 10 | 📅 2026-03-02
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/zjukg/KG-LLM-Papers/blob/main/LICENSE) ⭐ 2,232 | 🐛 10 | 📅 2026-03-02
...
* \[[arxiv](https://arxiv.org/abs/2405.14831)] HippoRAG: Neurobiologically Inspired Long-Term Memory for Large Language Models  `2024.05` \[[Repo](https://github.com/OSU-NLP-Group/HippoRAG) ⭐ 4,018 | 🐛 9 | 🌐 Python | 📅 2026-09-03]
* \[[arxiv](https://arxiv.org/abs/2304.02711)] Structured prompt interrogation and recursive extraction of semantics (SPIRES): A method for populating knowledge bases using zero-shot learning. `2023.04` \[[Repo](https://github.com/monarch-initiative/ontogpt) ⭐ 1,025 | 🐛 80 | 🌐 Jupyter Notebook | 📅 2026-09-10]
